...
var framesAndrew = [{b1:10,b2:0},{b1:2, b2:6}, {b1:2,b2:2},{b1:0,b2:0},{b1:0,b2:0},{b1:0,b2:0},{b1:0,b2:0},{b1:0,b2:0},{b1:0,b2:0,b3:0}];
...
var framesJasmine =  [{b1:10,b2:0},{b1:3, b2:6},{b1:1, b2:1},{b1:1,b2:1},{b1:1,b2:1},{b1:1,b2:1},{b1:1,b2:1},{b1:1,b2:1},{b1:1,b2:1},{b1:1,b2:1,b3:0}];
...
describe('bowlingScore', ()=> {
	...
	it('should add DOUBLE BONUS points for a strike', function(){
		...
		expect(bowlingScore(framesAndrew)).to.be.equal(30);
	});
	it('should give frame 10 Two or Three throws', function(){
		expect(bowlingScore(framesJasmine)).to.be.equal(44);
	});
});
